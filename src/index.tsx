  ...
  <main class="app-shell">
    ...
    <section class="workspace">
      ...
      <section id="dashboard-view" class="view-panel">
        ...
        <section class="panel order-panel"><div class="panel-heading"><div><p class="eyebrow">ORDER BARU</p><h2>Minta nomor verifikasi</h2></div><span class="step">02</span></div><p class="muted">Pilih layanan setelah koneksi berhasil diverifikasi.</p><label class="field-label" for="service-select">Layanan</label><div id="service-dropdown" class="custom-select"><input id="service-select" type="hidden" disabled /><button id="service-trigger" class="select-trigger" type="button" aria-haspopup="listbox" aria-expanded="false" disabled><span id="service-label">Hubungkan provider terlebih dahulu</span><span class="select-chevron">⌄</span></button><div id="service-options" class="select-options" role="listbox" hidden></div></div><button id="order-button" class="button button-primary" type="button" disabled>Buat order</button><div id="balance-box" class="balance-box" hidden><span>Saldo tersedia</span><strong id="balance-value">—</strong></div></section></div>
        <section id="active-order" class="panel active-order" hidden><div class="panel-heading"><div><p class="eyebrow">ORDER AKTIF</p><h2 id="order-service">Menunggu order</h2></div><span id="order-state" class="status-pill is-waiting">MENUNGGU</span></div><div class="order-data"><div><span>Nomor</span><strong id="order-number">—</strong></div><div><span>Kode verifikasi</span><strong id="otp-code">Belum tersedia</strong></div><div><span>Referensi</span><strong id="order-reference">—</strong></div></div><div class="button-group"><button id="check-button" class="button button-secondary" type="button">Cek kode sekarang</button><button id="copy-button" class="button button-quiet" type="button">Salin nomor</button><button id="cancel-button" class="button button-danger" type="button">Batalkan</button></div></section>
      </section>
